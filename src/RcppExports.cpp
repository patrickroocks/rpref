...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(get_hasse_impl(scores, serial_pref));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(pref_select_top_impl(scores, serial_pref, N, alpha, top, at_least, toplevel, and_connected, show_levels));
    return __result;
END_RCPP
}
// grouped_pref_sel_top_impl
DataFrame grouped_pref_sel_top_impl(DataFrame data, DataFrame scores, List serial_pref, int N, double alpha, int top, int at_least, int toplevel, bool and_connected, bool show_levels);
RcppExport SEXP rPref_grouped_pref_sel_top_impl(SEXP dataSEXP, SEXP scoresSEXP, SEXP serial_prefSEXP, SEXP NSEXP, SEXP alphaSEXP, SEXP topSEXP, SEXP at_leastSEXP, SEXP toplevelSEXP, SEXP and_connectedSEXP, SEXP show_levelsSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< bool >::type and_connected(and_connectedSEXP);
    Rcpp::traits::input_parameter< bool >::type show_levels(show_levelsSEXP);
    __result = Rcpp::wrap(grouped_pref_sel_top_impl(data, scores, serial_pref, N, alpha, top, at_least, toplevel, and_connected, show_levels));
    return __result;
END_RCPP
}
// pref_select_impl
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    __result = Rcpp::wrap(pref_select_impl(scores, serial_pref, N, alpha));
    return __result;
END_RCPP
}
...
RcppExport SEXP rPref_grouped_pref_sel_impl(SEXP dataSEXP, SEXP scoresSEXP, SEXP serial_prefSEXP, SEXP NSEXP, SEXP alphaSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< DataFrame >::type data(dataSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    __result = Rcpp::wrap(grouped_pref_sel_impl(data, scores, serial_pref, N, alpha));
    return __result;
END_RCPP
}
