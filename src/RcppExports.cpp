...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        DataFrame __result = pref_select_top_impl(scores, serial_pref, N, alpha, top, at_least, toplevel, and_connected, show_levels);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< bool >::type and_connected(and_connectedSEXP );
        Rcpp::traits::input_parameter< bool >::type show_levels(show_levelsSEXP );
        DataFrame __result = grouped_pref_sel_top_impl(data, scores, serial_pref, N, alpha, top, at_least, toplevel, and_connected, show_levels);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< int >::type N(NSEXP );
        Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP );
        NumericVector __result = pref_select_impl(scores, serial_pref, N, alpha);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< int >::type N(NSEXP );
        Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP );
        NumericVector __result = grouped_pref_sel_impl(data, scores, serial_pref, N, alpha);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
