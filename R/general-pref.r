...
#' @param value A data frame or data frame extension (e.g., a tibble) to associate with a preference object.
...
#' @docType methods
setMethod(
  "as.expression", signature(x = "preference"),
  function(x, ...) {
    methods::callNextMethod()
  }
)
